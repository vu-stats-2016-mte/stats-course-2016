...
printhypotest <- function(res,test_statistic,null_hypothesis,claim){
  ...
  s=paste("#### Hypothesis test report\n\n - Null hypothesis:",null_hypothesis,
        ...
        "\n - Observed value:",res$estimate[1]-res$estimate[2],
        "\n - p-value:",res$p.value)
...
printhypotest(res,"Difference in means","True difference in means is equal to 0","Alice and Bob work the same amount of hours")
```
...
printhypotest(res,"Difference in means","True difference in means is less than or equal to 0","Alice works more than Bob")
```
...
printhypotest(res,"Difference in proportions","True difference in proportions is less than or equal to 0 ","The proportion of evenings on which Alice worked more than 3.5 hours is larger than the proportion of evenings on which Bob worked more than 3.5 hours")
```
