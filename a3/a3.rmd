...
printhypotest(res,"$Teq = \\frac{((\\bar{x}_1-\\bar{x}_2)-(\\mu_1-\\mu_2))}{\\sqrt[2]{S_p^2/n_1 + S_p^2/n_2}}$ \n\n\t with $S_p^2 = \\frac{(n_1-1)*S_2^1+(n_2-1)*S_2^2}{n_1+n_2-2}$","True difference in proportions is less than or equal to 0 ","The proportion of evenings on which Alice worked more than 3.5 hours is larger than the proportion of evenings on which Bob worked more than 3.5 hours")
```
